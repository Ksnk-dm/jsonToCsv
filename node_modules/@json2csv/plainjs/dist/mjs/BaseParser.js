import { default as defaultFormatter, number as numberFormatterCtor, object as objectFormatterCtor, string as stringFormatterCtor, symbol as symbolFormatterCtor, } from '@json2csv/formatters';
...
export default class JSON2CSVBase {
    ...
    preprocessOpts(opts) {
        ...
        const stringFormatter = processedOpts.formatters?.string || stringFormatterCtor();
