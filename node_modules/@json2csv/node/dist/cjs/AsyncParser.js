...
class JSON2CSVNodeAsyncParser {
    ...
    parse(data) {
        ...
        if (typeof data === 'string' || ArrayBuffer.isView(data)) {
            data = node_stream_1.Readable.from(data, { objectMode: false });
        }
        else if (Array.isArray(data)) {
            data = node_stream_1.Readable.from(data.filter((item) => item !== null));
        }
        else if (typeof data === 'object' && !(data instanceof node_stream_1.Readable)) {
            data = node_stream_1.Readable.from([data]);
        }
        ...
        return data.pipe(new Transform_js_1.default(this.opts, this.asyncOpts, {
