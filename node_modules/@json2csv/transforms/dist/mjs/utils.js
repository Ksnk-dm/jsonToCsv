...
export function setProp(obj, path, value) {
    ...
    return {
        ...
        [key]: pathArray.length > 1
            ? setProp(obj[key] || {}, restPath, value)
            : value,
    };
}
export function unsetProp(obj, path) {
    ...
    if (pathArray.length === 1) {
        return Object.fromEntries(Object.entries(obj).filter(([prop]) => prop !== key));
    }
    return Object.fromEntries(Object.entries(obj).map(([prop, value]) => [
        prop,
